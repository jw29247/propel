...
propel system heartbeat last
propel logs --follow
propel config get agents.defaults.heartbeat
propel channels status --probe
```
...
```bash
propel config get agents.defaults.heartbeat.activeHours
propel config get agents.defaults.heartbeat.activeHours.timezone
propel config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
propel cron list
propel logs --follow
```
