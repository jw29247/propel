...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Propel HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `propel pairing approve slack <code>`.
...
Propel supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Propel falls back to normal delivery for remaining payloads.
