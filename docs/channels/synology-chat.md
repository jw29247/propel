---
summary: "Synology Chat webhook setup and Propel config"
read_when:
  - Setting up Synology Chat with Propel
...
```bash
propel plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Propel gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Propel.
...
- Pairing approvals work with:
  - `propel pairing list synology-chat`
  - `propel pairing approve synology-chat <CODE>`
...
```bash
propel message send --channel synology-chat --target 123456 --text "Hello from Propel"
propel message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
