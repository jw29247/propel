...
- Install via CLI: `propel plugins install @propel/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `propel plugins install ./extensions/zalo`
   - From npm (if published): `propel plugins install @propel/zalo`
...
- Approve via:
  - `propel pairing list zalo`
  - `propel pairing approve zalo <CODE>`
...
- Example: `propel message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `propel channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `propel logs --follow`
