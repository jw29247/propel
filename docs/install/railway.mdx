...
Deploy Propel on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/propel` — Control UI
...
- `PROPEL_STATE_DIR=/data/.propel` (recommended)
- `PROPEL_WORKSPACE_DIR=/data/workspace` (recommended)
- `PROPEL_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Propel state + workspace so you can migrate to another host without losing config or memory.
