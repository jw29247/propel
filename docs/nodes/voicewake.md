...
Propel treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.propel/settings/voicewake.json`

Shape:

```json
{ "triggers": ["propel", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
