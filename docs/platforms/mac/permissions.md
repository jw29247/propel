...
- Same path: run the app from a fixed location (for Propel, `dist/Propel.app`).
...
Workaround: move files into the Propel workspace (`~/.propel/workspace`) if you want to avoid per-folder grants.
