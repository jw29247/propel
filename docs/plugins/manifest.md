...
read_when:
  - You are building a Propel plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (propel.plugin.json)

Every plugin **must** ship a `propel.plugin.json` file in the **plugin root**.
Propel uses this manifest to validate configuration **without executing plugin
