...
You can point Propel at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Propel
...
- [Anthropic provider](/providers/anthropic) - Native Propel integration with Claude setup-token or API keys
