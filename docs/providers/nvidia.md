---
summary: "Use NVIDIA's OpenAI-compatible API in Propel"
read_when:
  - You want to use NVIDIA models in Propel
...
propel onboard --auth-choice skip
propel models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
