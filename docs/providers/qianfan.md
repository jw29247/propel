---
summary: "Use Qianfan's unified API to access many models in Propel"
read_when:
...
3. Propel installed on your system
...
4. Copy the API key for use with Propel

## CLI setup

```bash
propel onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Propel Configuration](/gateway/configuration)
