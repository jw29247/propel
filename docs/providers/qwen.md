---
summary: "Use Qwen OAuth (free tier) in Propel"
read_when:
  - You want to use Qwen with Propel
...
If you already logged in with the Qwen Code CLI, Propel will sync credentials
