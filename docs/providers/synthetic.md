---
summary: "Use Synthetic's Anthropic-compatible API in Propel"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Propel registers it as the
...
Note: Propel's Anthropic client appends `/v1` to the base URL, so use
