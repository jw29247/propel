---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Propel"
read_when:
  - You want Xiaomi MiMo models in Propel
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Propel uses
