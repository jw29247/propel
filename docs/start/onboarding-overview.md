---
summary: "Overview of Propel onboarding options and flows"
read_when:
...
Propel supports multiple onboarding paths depending on where the Gateway runs
...
- [`propel onboard` command](/cli/onboard)

## macOS app onboarding

Use the Propel app when you want a fully guided setup on macOS. Docs:
