---
summary: "First-run onboarding flow for Propel (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Propel">
...
<Step title="CLI">
  ...
  The app can install the global `propel` CLI via npm/pnpm so terminal
