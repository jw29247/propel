...
本指南总结了在 Propel 中开发 Pi 集成的合理工作流程。
...
状态存储在 Propel 状态目录下。默认为 `~/.propel`。如果设置了 `PROPEL_STATE_DIR`，则使用该目录。
...
- https://docs.propel.ai/testing
- https://docs.propel.ai/start/getting-started
