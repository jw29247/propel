...
This directory contains the **BlueBubbles external channel plugin** for Propel.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `propel/plugin-sdk` helpers.
