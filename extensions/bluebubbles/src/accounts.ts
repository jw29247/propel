...
export function listBlueBubblesAccountIds(cfg: PropelConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: PropelConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: PropelConfig): ResolvedBlueBubblesAccount[] {
