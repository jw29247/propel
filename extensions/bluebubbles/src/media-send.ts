...
import { resolveChannelMediaMaxBytes, type PropelConfig } from "propel/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: PropelConfig; accountId?: string }): string[] {
