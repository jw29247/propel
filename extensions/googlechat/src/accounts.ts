...
export function listGoogleChatAccountIds(cfg: PropelConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: PropelConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: PropelConfig): ResolvedGoogleChatAccount[] {
