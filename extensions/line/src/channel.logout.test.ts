import type { PropelConfig, PluginRuntime, ResolvedLineAccount } from "propel/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: PropelConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: PropelConfig; accountId: string }): Promise<{
