...
export function listMattermostAccountIds(cfg: PropelConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: PropelConfig): string {
...
export function listEnabledMattermostAccounts(cfg: PropelConfig): ResolvedMattermostAccount[] {
