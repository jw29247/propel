import type { ChannelOnboardingAdapter, PropelConfig, WizardPrompter } from "propel/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.propel.ai/channels/mattermost",
    ].join("\n"),
