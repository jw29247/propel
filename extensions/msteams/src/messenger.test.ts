...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "propel/plugin-sdk";
...
import { resolvePreferredPropelTmpDir } from "../../../src/infra/tmp-propel-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredPropelTmpDir(), "msteams-mention-"));
