...
Nostr DM channel plugin for Propel using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Propel. It enables your bot to:
...
# Configure propel to use local relay
