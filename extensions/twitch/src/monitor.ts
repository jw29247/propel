...
import type { ReplyPayload, PropelConfig } from "propel/plugin-sdk";
import { createReplyPrefixOptions } from "propel/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as PropelConfig;
