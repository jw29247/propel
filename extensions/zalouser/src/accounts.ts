...
export function listZalouserAccountIds(cfg: PropelConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: PropelConfig): string {
...
function mergeZalouserAccountConfig(cfg: PropelConfig, accountId: string): ZalouserAccountConfig {
