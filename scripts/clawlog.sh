...
show_usage() {
    cat << EOF
clawlog - Propel Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Propel logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Propel logs flow through the macOS unified log (subsystem: ai.propel).
