...
ENT_TMP_BASE=$(mktemp -t propel-entitlements-base.XXXXXX)
ENT_TMP_APP_BASE=$(mktemp -t propel-entitlements-app-base.XXXXXX)
ENT_TMP_RUNTIME=$(mktemp -t propel-entitlements-runtime.XXXXXX)
