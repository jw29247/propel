...
- Keep product names in English: Propel, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Propel Gateway, use “Gateway 网关”.
