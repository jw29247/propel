...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "propel", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Propel. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Propel Issue Label Audit");
