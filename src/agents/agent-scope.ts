...
type AgentEntry = NonNullable<NonNullable<PropelConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: PropelConfig): AgentEntry[] {
...
export function listAgentIds(cfg: PropelConfig): string[] {
...
export function resolveDefaultAgentId(cfg: PropelConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: PropelConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: PropelConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: PropelConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: PropelConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
