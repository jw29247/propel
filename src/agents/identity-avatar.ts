...
function resolveAvatarSource(cfg: PropelConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: PropelConfig, agentId: string): AgentAvatarResolution {
