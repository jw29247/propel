...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolvePropelAgentDir();
 ...
 * a hint.
 *
 * See: https://github.com/jw29247/propel/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "propel configure". ' +
    "See: https://docs.propel.ai/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "propel configure". ' +
    "See: https://docs.propel.ai/providers/vllm",
};
