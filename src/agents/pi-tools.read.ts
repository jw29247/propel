...
function resolveAdaptiveReadMaxBytes(options?: PropelReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createPropelReadTool(base, {
...
export function createPropelReadTool(
  base: AnyAgentTool,
  options?: PropelReadToolOptions,
): AnyAgentTool {
