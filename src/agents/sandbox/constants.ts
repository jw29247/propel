...
export const DEFAULT_SANDBOX_IMAGE = "propel-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "propel-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "propel-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "propel-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "propel-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "propel-sandbox-browser";
