...
const CLEANUP_STATE_KEY = Symbol.for("propel.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("propel.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("propel.sessionWriteLockWatchdogState");
