...
function resolveWatchPaths(workspaceDir: string, config?: PropelConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: PropelConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: PropelConfig }) {
