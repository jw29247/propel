...
function asPropelConfig(config: Partial<PropelConfig>): PropelConfig {
  return config as PropelConfig;
}

function createToolConfig() {
  return asPropelConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: PropelConfig = createToolConfig()) {
