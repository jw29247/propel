...
function resolveMemoryToolContext(options: { config?: PropelConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: PropelConfig): MemoryCitationsMode {
