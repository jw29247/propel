...
export function resolveSessionToolsVisibility(cfg: PropelConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: PropelConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: PropelConfig): AgentToAgentPolicy {
