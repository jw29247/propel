...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): PropelConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: PropelConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: PropelConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
