...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@propel", { botUsername: "propel" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@propel args", {
        botUsername: "propel",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "propel" })).toBe(
      "/help@otherbot",
    );
  });
