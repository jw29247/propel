...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated propel relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedPropelRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-propel-relay-token",
