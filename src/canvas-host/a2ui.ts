...
export const A2UI_PATH = "/__propel__/a2ui";

export const CANVAS_HOST_PATH = "/__propel__/canvas";

export const CANVAS_WS_PATH = "/__propel__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.propelCanvasA2UIAction.postMessage(...)
  // - Android: window.propelCanvasA2UIAction.postMessage(...)
  const handlerNames = ["propelCanvasA2UIAction"];
  ...
  globalThis.Propel = globalThis.Propel ?? {};
  globalThis.Propel.postMessage = postToNode;
  globalThis.Propel.sendUserAction = sendUserAction;
  globalThis.propelPostMessage = postToNode;
  globalThis.propelSendUserAction = sendUserAction;
