...
export function listChannelMessageActions(cfg: PropelConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: PropelConfig): boolean {
...
export function supportsChannelMessageCards(cfg: PropelConfig): boolean {
