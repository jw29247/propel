...
export type ChannelAgentToolFactory = (params: { cfg?: PropelConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: PropelConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: PropelConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: PropelConfig }) => boolean;
  supportsCards?: (params: { cfg: PropelConfig }) => boolean;
