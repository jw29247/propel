    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["propel channels list", "List configured channels and auth profiles."],
          ["propel channels status --probe", "Run channel status checks and probes."],
          [
            "propel channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["propel channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.propel.ai/cli/channels",
        )}\n`,
    );
