    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["propel directory self --channel slack", "Show the connected account identity."],
          [
            'propel directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["propel directory groups list --channel discord", "List available groups/channels."],
          [
            "propel directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.propel.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
