      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["propel gateway run", "Run the gateway in the foreground."],
            ["propel gateway status", "Show service status and probe reachability."],
            ["propel gateway discover", "Find local and wide-area gateway beacons."],
            ["propel gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.propel.ai/cli/gateway")}\n`,
      ),
  );
