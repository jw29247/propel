...
const SANDBOX_EXAMPLES = {
  main: [
    ["propel sandbox list", "List all sandbox containers."],
    ["propel sandbox list --browser", "List only browser containers."],
    ["propel sandbox recreate --all", "Recreate all containers."],
    ["propel sandbox recreate --session main", "Recreate a specific session."],
    ["propel sandbox recreate --agent mybot", "Recreate agent containers."],
    ["propel sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["propel sandbox list", "List all sandbox containers."],
    ["propel sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["propel sandbox recreate --all", "Recreate all containers."],
    ["propel sandbox recreate --session main", "Recreate a specific session."],
    ["propel sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["propel sandbox recreate --browser --all", "Recreate only browser containers."],
    ["propel sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["propel sandbox explain", "Show effective sandbox config."],
    ["propel sandbox explain --session agent:main:main", "Explain a specific session."],
    ["propel sandbox explain --agent work", "Explain an agent sandbox."],
    ["propel sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.propel.ai/cli/sandbox")}\n`,
    )
    .action(() => {
