const DEFAULT_TAGLINE = "Your operations, on autopilot.";
...
const TAGLINES: string[] = [
  "Your terminal just got smarter—type something and let the bot handle the busywork.",
  ...
  "Automation with precision: minimal fuss, maximal impact.",
  ...
  "Engines on, commit in—let's ship something mildly responsible.",
  "I'll streamline your workflow: clean, efficient, effective.",
  "Shell yeah—I'm here to eliminate the toil and leave you the glory.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.PROPEL_TAGLINE_INDEX;
