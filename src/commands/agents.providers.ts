...
function resolveDefaultAccountId(cfg: PropelConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: PropelConfig): boolean {
...
export function summarizeBindings(cfg: PropelConfig, bindings: AgentBinding[]): string[] {
