...
export function applyVercelAiGatewayProviderConfig(cfg: PropelConfig): PropelConfig {
...
export function applyVercelAiGatewayConfig(cfg: PropelConfig): PropelConfig {
