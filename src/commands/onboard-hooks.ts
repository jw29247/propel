...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.propel.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("propel hooks list")}`,
      `  ${formatCliCommand("propel hooks enable <name>")}`,
      `  ${formatCliCommand("propel hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
