...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Propel status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("propel security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("propel security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.propel.ai/faq");
  runtime.log("Troubleshooting: https://docs.propel.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("propel status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("propel logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("propel status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("propel gateway probe")}`);
  }
}
