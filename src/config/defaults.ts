...
function resolveAnthropicDefaultAuthMode(cfg: PropelConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: PropelConfig): PropelConfig {
...
export function applyTalkApiKey(config: PropelConfig): PropelConfig {
...
export function applyModelDefaults(cfg: PropelConfig): PropelConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: PropelConfig): PropelConfig {
...
export function applyLoggingDefaults(cfg: PropelConfig): PropelConfig {
...
export function applyContextPruningDefaults(cfg: PropelConfig): PropelConfig {
...
export function applyCompactionDefaults(cfg: PropelConfig): PropelConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
