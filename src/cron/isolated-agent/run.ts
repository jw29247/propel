...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/jw29247/propel/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.PROPEL_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.propel/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: PropelConfig = {
    ...params.cfg,
