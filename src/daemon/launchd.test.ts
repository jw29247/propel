...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.propel.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", PROPEL_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.propel.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when PROPEL_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.propel.gateway.plist",
    },
    {
      name: "uses profile-specific label when PROPEL_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", PROPEL_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.propel.jbphoenix.plist",
    },
    {
      name: "prefers PROPEL_LAUNCHD_LABEL over PROPEL_PROFILE",
      env: {
        HOME: "/Users/test",
        PROPEL_PROFILE: "jbphoenix",
        PROPEL_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from PROPEL_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        PROPEL_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty PROPEL_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        PROPEL_PROFILE: "myprofile",
        PROPEL_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.propel.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
