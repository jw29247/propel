...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.PROPEL_STATE_DIR;
  const configPath = env.PROPEL_CONFIG_PATH;
  ...
  return {
    ...
    PROPEL_PROFILE: profile,
    PROPEL_STATE_DIR: stateDir,
    PROPEL_CONFIG_PATH: configPath,
    PROPEL_GATEWAY_PORT: String(port),
    PROPEL_GATEWAY_TOKEN: token,
    PROPEL_LAUNCHD_LABEL: resolvedLaunchdLabel,
    PROPEL_SYSTEMD_UNIT: systemdUnit,
    PROPEL_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    PROPEL_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    PROPEL_STATE_DIR: stateDir,
    PROPEL_CONFIG_PATH: configPath,
    PROPEL_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    PROPEL_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    PROPEL_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    PROPEL_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    PROPEL_LOG_PREFIX: "node",
    PROPEL_SERVICE_MARKER: NODE_SERVICE_MARKER,
    PROPEL_SERVICE_KIND: NODE_SERVICE_KIND,
    PROPEL_SERVICE_VERSION: VERSION,
  };
}
