...
function mergeDiscordAccountConfig(cfg: PropelConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: PropelConfig): ResolvedDiscordAccount[] {
