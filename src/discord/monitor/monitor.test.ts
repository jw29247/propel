...
describe("agent components", () => {
  const createCfg = (): PropelConfig => ({}) as PropelConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/propel-sessions-test.json");
  });
