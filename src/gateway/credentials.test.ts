...
function cfg(input: Partial<PropelConfig>): PropelConfig {
  return input as PropelConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<PropelConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  PROPEL_GATEWAY_TOKEN: "env-token",
  PROPEL_GATEWAY_PASSWORD: "env-password",
