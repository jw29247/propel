...
beforeAll(async () => {
  previousToken = process.env.PROPEL_GATEWAY_TOKEN;
  process.env.PROPEL_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
afterAll(async () => {
  ...
  if (previousToken === undefined) {
    ...
    process.env.PROPEL_GATEWAY_TOKEN = previousToken;
  }
});
...
test.each([
  { clientId: "propel-ios", platform: "ios" },
  { clientId: "propel-android", platform: "android" },
