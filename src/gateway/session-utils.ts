...
import { type PropelConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: PropelConfig): string[] {
...
export function listAgentsForGateway(cfg: PropelConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: PropelConfig): string {
...
function resolveSessionStoreAgentId(cfg: PropelConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: PropelConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: PropelConfig): GatewaySessionsDefaults {
