...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: PropelConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: PropelConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__propelMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__propelMcporterColdStartWarned;
  });
