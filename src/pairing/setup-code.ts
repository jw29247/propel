...
function resolveGatewayPort(cfg: PropelConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: PropelConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.PROPEL_GATEWAY_PASSWORD?.trim() ||
