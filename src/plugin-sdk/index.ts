...
export type { PropelConfig } from "../config/config.js";
/** @deprecated Use PropelConfig instead */
export type { PropelConfig as ClawdbotConfig } from "../config/config.js";
