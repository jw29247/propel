...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @propel/voice-call -> voice-call).
...
export function discoverPropelPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".propel", "extensions")];
