...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/propel/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/propel/extensions",
        global: "/Users/x/.propel/extensions",
        workspace: "/Users/x/ws/.propel/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.propel/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/propel/extensions",
        global: "/Users/x/.propel/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.propel/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/propel/extensions",
        global: "/Users/x/.propel/extensions",
