...
export type PropelPluginConfigSchema = {
...
export type PropelPluginToolContext = {
  config?: PropelConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type PropelPluginToolFactory = (
  ctx: PropelPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type PropelPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type PropelPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<PropelConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type PropelPluginGatewayMethod = {
  method: string;
 ...
 */
export type PropelPluginCommandDefinition = {
...
export type PropelPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type PropelPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type PropelPluginCliContext = {
  program: Command;
  config: PropelConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type PropelPluginCliRegistrar = (ctx: PropelPluginCliContext) => void | Promise<void>;

export type PropelPluginServiceContext = {
  config: PropelConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type PropelPluginService = {
  id: string;
  start: (ctx: PropelPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: PropelPluginServiceContext) => void | Promise<void>;
};

export type PropelPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type PropelPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: PropelPluginConfigSchema;
  register?: (api: PropelPluginApi) => void | Promise<void>;
  activate?: (api: PropelPluginApi) => void | Promise<void>;
};

export type PropelPluginModule =
  | PropelPluginDefinition
  | ((api: PropelPluginApi) => void | Promise<void>);

export type PropelPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | PropelPluginToolFactory,
    opts?: PropelPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: PropelPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: PropelPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: PropelPluginHttpRouteHandler }) => void;
  registerChannel: (registration: PropelPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: PropelPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: PropelPluginService) => void;
   ...
   */
  registerCommand: (command: PropelPluginCommandDefinition) => void;
