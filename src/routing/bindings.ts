...
export function listBindings(cfg: PropelConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: PropelConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: PropelConfig) {
