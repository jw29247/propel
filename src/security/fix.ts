...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof PropelConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: PropelConfig; env: NodeJS.ProcessEnv }): {
  cfg: PropelConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
