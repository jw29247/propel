...
function mergeSignalAccountConfig(cfg: PropelConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: PropelConfig): ResolvedSignalAccount[] {
