...
function mergeSlackAccountConfig(cfg: PropelConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: PropelConfig): ResolvedSlackAccount[] {
