...
// Prefix for Propel-generated action IDs to scope our handler
const PROPEL_ACTION_PREFIX = "propel:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${PROPEL_ACTION_PREFIX}`);

  // Handle Propel modal submissions with callback_ids scoped by our prefix.
