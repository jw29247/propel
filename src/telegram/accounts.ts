...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.PROPEL_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: PropelConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: PropelConfig): string {
...
function mergeTelegramAccountConfig(cfg: PropelConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: PropelConfig): ResolvedTelegramAccount[] {
