...
export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "PROPEL_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "PROPEL_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "PROPEL_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable PROPEL_TELEGRAM_DNS_RESULT_ORDER
