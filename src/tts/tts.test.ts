...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.PROPEL_TTS_PREFS;
      process.env.PROPEL_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.PROPEL_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: PropelConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
