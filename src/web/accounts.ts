...
export function listWhatsAppAuthDirs(cfg: PropelConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: PropelConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: PropelConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: PropelConfig): ResolvedWhatsAppAccount[] {
