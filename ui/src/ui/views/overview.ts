...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">propel devices list</span><br />
          <span class="mono">propel devices approve &lt;requestId&gt;</span>
        </div>
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.propel.ai/web/control-ui#device-pairing-first-connection"
            target="_blank"
            rel="noreferrer"
  ...
  const authHint = (() => {
    ...
    if (isAuthRequired) {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">propel dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">propel doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://docs.propel.ai/web/dashboard"
              target="_blank"
              rel="noreferrer"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "propel dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.propel.ai/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.propel.ai/gateway/tailscale"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            class="session-link"
            href="https://docs.propel.ai/web/control-ui#insecure-http"
            target="_blank"
            rel="noreferrer"
              ...
              : html`
                <label class="field">
                  ...
                  <input
                    ...
                    placeholder="PROPEL_GATEWAY_TOKEN"
                  />
                </label>
                <label class="field">
